            ...
            <div class="row">
                <div class="col-4">
                    <div class="wrap-follow">
                        ...
                        <ul>
                            <li>
                                <img src="assets/icon/fb.png" width="40px"> <a href="https://www.facebook.com/">Facebook</a>
                            </li>
                            <li>
                                <img src="assets/icon/yt.png" width="40px"> <a href="https://www.youtube.com/">Youtube</a>
                            </li>
                            <li>
                                <img src="assets/icon/ig.jpj" width="40px"> <a href="https://www.instagram.com/">Instagram</a>
                            </li>
                            <li>
                                <img src="assets/icon/telegram.png" width="40px"> <a href="https://web.telegram.org/">Telegram</a>
                            </li>
                            <li>
                                <img src="assets/icon/gmail-1.png" width="40px"> <a href="https://email.com/">Email</a>
                            </li>
                            <li>
                                <img src="assets/icon/tiktok.png" width="40px"> <a href="https://www.tiktok.com/login">Tok Tok</a>
                            </li>
                            <li>
