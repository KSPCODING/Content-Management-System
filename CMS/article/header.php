    ...
    <header>
        <div class="container">
            ...
            <ul class="menu">
                ...
                <li class="menu-sport"><a href="javascript:void(0)">SPORT</a>
                ...
                <li class="menu-sport"><a href="javascript:void(0)">TECHNOLOGY</a>
                    <ul class="sub-menu sport">
                        <li>
                            <a href="technology-news-national.php">National</a>
                        </li>
                        <li>
                            <a href="technology-news-international.php">International</a>
                        </li>
                    </ul>
                </li>

                <li class="menu-sport"><a href="javascript:void(0)">SOCIAL</a>
                    <ul class="sub-menu sport">
                        <li>
                ...
                <li class="menu-sport"><a href="javascript:void(0)">ENTERTAINMENT</a>
                    <ul class="sub-menu sport">
                        <li>
